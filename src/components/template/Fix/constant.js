...
export const FIX_TEMPLATE_CTRLBTN_STATES = {
    VISIBLE: "FIX_TEMPATE_CTRLBTN_STATES/VISIBLE",
    INVISIBLE: "FIX_TEMPATE_CTRLBTN_STATES/INVISIBLE",
    FINISHED: "FIX_TEMPATE_CTRLBTN_STATES/FINISHED"
}